package cn.com.xxutils.alerterview;
...
public class XXAlertView {
    ...
    private ViewGroup rootView;//XXAlertView 的 根View
    private ViewGroup loAlertHeader;//窗口headerView

    private Style style = Style.Alert;

    private cn.com.xxutils.alerterview.OnDismissListener OnDismissListener;
    private cn.com.xxutils.alerterview.OnItemClickListener OnItemClickListener;
    ...
    public XXAlertView(String title, String msg, String cancel, String[] destructive, String[] others, Context context, Style style, cn.com.xxutils.alerterview.OnItemClickListener OnItemClickListener){
    ...
    protected void initListView(){
        ...
        alertButtonListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                if(OnItemClickListener != null) OnItemClickListener.onItemClick(XXAlertView.this,position);
                dismiss();
            }
        });
    }
    ...
    public XXAlertView addExtView(View extView){
                ...
                decorView.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (OnDismissListener != null) {
                            OnDismissListener.onDismiss(XXAlertView.this);
                        }
                    }
                });
            }
    ...
    public Animation getInAnimation() {
        int res = XXAlertAnimateUtil.getAnimationResource(this.gravity, true);
        return AnimationUtils.loadAnimation(context, res);
    }

    public Animation getOutAnimation() {
        int res = XXAlertAnimateUtil.getAnimationResource(this.gravity, false);
        return AnimationUtils.loadAnimation(context, res);
    }

    public XXAlertView setOnDismissListener(cn.com.xxutils.alerterview.OnDismissListener OnDismissListener) {
    ...
    public XXAlertView setCancelable(boolean isCancelable) {
