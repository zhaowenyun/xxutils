...
public class XXTouchImageView extends ImageView {
    ...
    public XXTouchImageView(Activity context, AttributeSet attrs) {
        super(context, attrs);
        gintama = BitmapFactory.decodeResource(getResources(), R.drawable.delete_wechat_icon);
    ...
    //    public XXTouchImageView(Activity activity,Bitmap bitmap) {
//        super(activity);
//        this.gintama=bitmap;
