 ...
 * @author lxj
 */
public class XXCustomListView extends ListView implements AbsListView.OnScrollListener {
    ...
    public XXCustomListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
