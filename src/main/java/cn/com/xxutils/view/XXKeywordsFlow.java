...
public class XXKeywordsFlow extends FrameLayout implements OnGlobalLayoutListener{
    ...
    public XXKeywordsFlow(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public XXKeywordsFlow(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public XXKeywordsFlow(Context context) {
        super(context);  
        init();  
    }  
