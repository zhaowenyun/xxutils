...
public class XXRSAUtils {
    ...
    public static String sign(byte[] data, String privateKey) throws Exception {
        byte[] keyBytes = XXBase64Utils.decode(privateKey);
        ...
        return XXBase64Utils.encode(signature.sign());
    }


    public static boolean verify(byte[] data, String publicKey, String sign)
            throws Exception {
        byte[] keyBytes = XXBase64Utils.decode(publicKey);
        ...
        signature.update(data);
        return signature.verify(XXBase64Utils.decode(sign));
    }
...
//        Cipher cipher = Cipher.getInstance("RSA/ECB/NoPadding");
    ...
    public static String getPrivateKey(Map<String, Object> keyMap)
        ...
        return XXBase64Utils.encode(key.getEncoded());
    }
