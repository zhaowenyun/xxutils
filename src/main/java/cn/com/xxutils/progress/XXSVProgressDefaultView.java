 ...
 * 默认的SVProgress效果
 */
public class XXSVProgressDefaultView extends LinearLayout {
    ...
    private XXSVCircleProgressBar circleProgressBar;
    private TextView tvMsg;

    private RotateAnimation mRotateAnimation;

    public XXSVProgressDefaultView(Context context) {
        super(context);
        initViews();
        init();
    }
    ...
    private void initViews() {
        ...
        circleProgressBar = (XXSVCircleProgressBar) findViewById(R.id.circleProgressBar);
    ...
    public XXSVCircleProgressBar getCircleProgressBar() {
