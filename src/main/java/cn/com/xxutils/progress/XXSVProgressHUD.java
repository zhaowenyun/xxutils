package cn.com.xxutils.progress;
 ...
 */
public class XXSVProgressHUD {
    private Context context;
    private static XXSVProgressHUD mXXSVProgressHUD;
    ...
    private XXSVProgressDefaultView mSharedView;

    private Animation outAnim;
    private Animation inAnim;
    private int gravity = Gravity.CENTER;

    private static final XXSVProgressHUD getInstance(Context context) {
        if (mXXSVProgressHUD == null) {
            mXXSVProgressHUD = new XXSVProgressHUD();
            mXXSVProgressHUD.context = context;
            mXXSVProgressHUD.gravity = Gravity.CENTER;
            mXXSVProgressHUD.initViews();
            mXXSVProgressHUD.initDefaultView();
            mXXSVProgressHUD.initAnimation();
        }
        if (context != null && context != mXXSVProgressHUD.context ){
            mXXSVProgressHUD.context = context;
            mXXSVProgressHUD.initViews();
        }

        return mXXSVProgressHUD;
    }
    ...
    protected void initDefaultView(){
        mSharedView = new XXSVProgressDefaultView(context);
    ...
    public static XXSVCircleProgressBar getProgressBar(Context context){
    ...
    public Animation getInAnimation() {
        int res = XXSVProgressHUDAnimateUtil.getAnimationResource(this.gravity, true);
        return AnimationUtils.loadAnimation(context, res);
    }

    public Animation getOutAnimation() {
        int res = XXSVProgressHUDAnimateUtil.getAnimationResource(this.gravity, false);
        return AnimationUtils.loadAnimation(context, res);
    }
